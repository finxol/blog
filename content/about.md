...
Staying on the topic of carpool platforms, I'm currently building a federated carpool platform.
It's still in very early stages, so the [github repo](https://github.com/finxol/fedicarpool) is pretty bare,
there'll be more coming as I continue work.

Last potentially interesting thing is my [portfolio](https://colinozanne.fr).
I haven't actively worked on it in a couple but it still looks decent.
